...
export const culturesData: Culture[] = [
    {
        title: "Deep Mining",
        slug: "DEEP-MINING",
        description: ["The Deep Mining culture hails from the subterranean realms, where they've mastered the art of extracting precious stones and metals. Known for their resilience and craftsmanship, they carve magnificent halls and forge legendary artifacts beneath the earth."],
    ...
    },
    {
        title: "Forest Folk",
        slug: "FOREST-FOLK",
        description: ["The Forest Folk are a mystical elven culture deeply connected to the woods. Their elegant language, infused with nature's harmony, resonates with the rustling leaves and songs of birds. Renowned for their arboreal wisdom, they protect ancient groves and practice the arts and music."],
        ...
        traits: [
          {
            ...
            text: [{text:  "You always have Fortune's Favor on tests to communicate with characters who you don't share a language with."}]
          },
          {
    ...
    },
    {
        title: "The Mariners",
        slug: "MARINERS",
        description: ["The Mariners are seasoned sailors, tradesmen, and shipwrights, navigating the vast oceans of the world. Known for their seafaring instincts, they excel in maritime activities and shipbuilding."],
        ...
        traits: [
          {
            ...
            slug: "MARINERS-WATER",
            text: [{text:  "Double your normal swim speed and you can hold your breath for twice as long."}]
          },
          {
            title: "Knotty",
    ...
    },
    {
        ...
        slug: "HIGHLAND-CLANS",
        description: ["Highland Clans reside in rugged mountainous regions. Known for their expertise in mountain survival and climbing, they forge strong communal bonds and defend their territories with unwavering resolve."],
        stat: "+1 to Mettle or Heart",
        languages: "Allspeak",
        traits: [
          {
        ...
        traits: [
          {
            ...
            text: [{text:  "When you have Fortune’s Favor and an ally within 5ft of you is Tested, you can spend your Fortune’s Favor to grant them a +3 on the Test."}]
          },
          {
            title: "Meadowland Hospitality",
            slug: "MEADOWLANDS-HOSPITALITY",
            text: [{text:  "+2 bonus to Heart tests when talking with strangers for the first time."}]
          }
        ]
    },
    {
        title: "Fae Folk",
        slug: "FAE-FOLK",
        description: ["The Fae are a strange and enigmatic folk; they spend most of their time deep in the woods where the magic is strongest and the barrier between the world and the beyond is thin."],
