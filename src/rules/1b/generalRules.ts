        ...
        subRules: [
          {
            ...
            text: [
              {
                text: "When you would take damage and you are not Surprised, Unconscious or otherwise unaware of the damage, you can attempt to reduce the damage by spending 2 Stamina to roll your Deflect Dice, reducing the damage taken by the amount rolled.",
                type: "RULE",
              },
              {
                text: "_Depending on the source of the damage this might represent a last second dodge to reduce the effect of the blow or gritting your teeth through the damage to reduce the effect._",
                type: "RULE",
              },
              {
                text: "At level 1 your Deflect Dice is 1d4. Different classes increase their Deflect at different rates.",
                type: "RULE",
              },
              {
    ...
    subRules: [
      ...
      },
      {
        ...
        text: [
          ...
          {
            text: "Eg: You are trying to trick a guard into letting you go after being caught breaking curfew. You told him you forgot your pass at home and get a mixed success on the Heart test your GM called for. The guard believes you but insists on escorting you home to show him the pass.",
            type: "RULE",
          },
        ],
      },
      ...
      },
      {
        ...
        subRules: [
          ...
          },
          {
            ...
            text: [
              {
                text: "Require at least 1 Agility and 1 Mettle: +1 to Armor and increases your Deflect by 2.",
                type: "RULE",
              },
            ],
          },
          {
            ...
            text: [
              {
                text: "Require at least 3 mettle: +2 to Armor and when you Deflect, you can reroll 1s.",
                type: "RULE",
              },
            ],
          },
    ...
    subRules: [
      {
        ...
        text: [
          {
            text: "A full days march assumes 8 hours of marching.",
            type: "RULE",
          },
        ],
        subRules: [
        ...
        subRules: [
          {
            ...
            text: [
              {
                text: "If you move up to 10ft before jumping: (4 + 2 * Mettle) ft horizontally (Min 2 ft.)",
                type: "RULE",
              },
            ],
          },
