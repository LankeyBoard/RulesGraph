...
export const NoviceFeatures: GenericFeature[] = [
  {
    ...
    text: [
      {
        text: "When researching information in a library or another collection of knowledge, add a +3 to related Tests.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      {
        text: "On 3 Tests per Rest and Recuperation, instead of rolling dice, flip a coin. If you win the flip, you succeed on the Test. Otherwise, you fail.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      {
        text: "Learn another language. Add +3 to Intellect Tests to decipher languages and codes you don't already know.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      {
        text: "When you make an Intellect Test to heal a dying ally, add +3 to the roll.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      {
        text: "When you make a non-combat Test, before you roll, you can choose to treat the Test as though you rolled a 12. You can do this 3 times per Rest and Recuperation.",
      },
    ],
  },
  {
...
export const VeteranFeatures: GenericFeature[] = [
  {
    ...
    text: [
      {
        text: "If you move at least 15 ft. in a straight line before you make a non-magical Attack, increase your Damage Dice by 1 step and push the creature back 5 ft.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      {
        text: "You have become imbued with magic. Pick a damage type. Your attacks can deal damage of the chosen type instead of their regular damage type.",
      },
    ],
  },
  {
