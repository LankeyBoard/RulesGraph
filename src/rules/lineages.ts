...
export const lineagesData: Lineage[] = [
    ...
    },
    {
            ...
            traits: [{
                            ...
                            text: [{text: "You can see in dim light as though it were bright. You cannot see in total darkness."}]
                    },
                    {
                            title: "Diggy Hole",
                            slug: "DWARF-DIGGY-HOLE",
                            text: [{text: "You dig at twice the normal speed, gain Fortune's Favor on any Tests related to digging."}]
                    },
                    {
                            title: "Hearty",
                            slug: "DWARF-HEARTY",
    ...
    },
    {
            ...
            traits: [
                    ...
                    },
                    {
                            title: "Trance",
                            slug: "ELF-TRANCE",
                            text: [{text: "Instead of sleeping, you are able to enter a trance. While in a trance you cannot move, but remain aware of your surroundings. You have to trance for 6 hours to be fully rested."}]
                    }
            ]
    },
    {
