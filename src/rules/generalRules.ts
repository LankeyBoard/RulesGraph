    ...
    },
    {
        ...
        subRules:   [
            ...
            },
            {
                ...
                title:  "Health",
                ruleType:  "RULE",
                text: [{ text:  "Health represents the life force of your character. See Exhausted, Dying, Last Stand & Healing for what happens at 0 Health "}]
            },
            {
                slug:  "REST",
                title:  "Resting",
               ...
               subRules: [
                    {
                        ...
                        ruleType:  "RULE",
                        text: [{ text:  "When you have a moment, you can catch your breath, tending to your wounds, wiping down your weapons, and centering yourself. To Catch Your Breath, spend 10 minutes resting and performing light activities without interruption.\nAt the end of the rest, you regain all missing stamina.\nIf you are at 0 Health, you gain 1 Health. Some classes may also have features that refresh when you Catch Your Breath."}]
                    },
                    {
                        slug:  "REST-RELAX",
            ...
            },
            {
               ...
               subRules: [{
                ...
                },
                {
                    title:  "Hide",
                    slug: "HIDE-ACTION",
                    text: [{ text:  "When you are obscured from enemies you can try and hide. See the rules on stealth for how to handle this."}]
                },
                {
                    title:  "Slip Away",
                    slug: "SLIP-AWAY",
                    text: [{ text:  "Your movement does not trigger counter moves this round."}]
                }]
            },
            {
                slug:  "BASIC-COUNTERS",
               ...
               subRules: [{
                ...
                },
                {
                    title:  "Dive Roll",
                    slug: "DIVE-ROLL",
                    text: [{ text:  "Move up to half your Speed without triggering Counters."}]
                }]
            },
            {
                slug:  "MOVING-COMBAT",
                ...
                ruleType:  "RULE",
                text: [{ text:  "In addition to an action, you can move during your turn in combat, moving up to your Speed in any direction. You can move at any point during your turn, and can split your move before and after your action."},
                    {type: "EG", text:"You move 10 ft. Make an Attack and then move another 20 ft. If you move away from an enemy, they get a chance to make a counter attack against you as you try to slip by."}]
            },
            {
                slug:  "TAKING-DMG",
                title:  "Taking Damage",
        ...
        subRules: [
            ...
            },
            {
                ...
                },
                {
                    ...
                    slug: "MEDIUM-SHIELDS",
                    text: [{ text:  "Require at least 1 Agility and 1 Mettle: +2 to Armor and reduce clash damage taken by 2."}]
                },
                {
                    title:  "Heavy Shields",
                    slug: "HEAVY-SHIELDS",
                    text: [{ text:  "Require at least 3 mettle: +2 to Armor reduce clash damage taken by Mettle."}]
                }]
            },
            {
                title:  "Armor",
               ...
               subRules: [
                {
                    ...
                    text: [{ text:  "Likely - Pass: 10 Fail: 5"}, {text: "Unlikely - Pass: 15 Fail: 10"}, {text: "Very Unlikely - Pass: 18 Fail: 13"}]
                }
                ]
            }
        ]
        ...
        subRules: [
            {
                ...
                title:  "Exhausted",
                ruleType:  "RULE",
                text: [{ text:  "When your Stamina is reduced to 0 you are Exhausted. See statuses for more info."}]
            },
            {
                slug:  "DYING",
                title:  "Dying",
                ruleType:  "RULE",
                text: [{ text:  "When your Health is reduced to 0, you have been mortally wounded and are Dying. Taking an Action or moving more than half your speed costs 1 stamina. An ally can use the Help Action to aid you, removing the stamina cost as long as they stay within 5ft of you."}]
            },
            {
                slug:  "LAST-STAND",
                title:  "Last Stand",
            ...
            },
            {
                ...
                title:  "Death",
                ruleType:  "RULE",
                text: [{ text:  "When you have 0 Health & 0 Stamina you are dead and your soul begins to leave your body, making the long journey to The Tribunal and the lands beyond. Only magical resuscitation can bring you back."}]
            }
        ]
    },
    {
       ...
       subRules: [
            ...
            },
            {
                ...
                ruleType:  "RULE",
                text: [{ text:  "When you Catch Your Breath, you patch up and tend to any non life threatening injuries.\nIf you Catch Your Breath and are at 0 Health, you regain 1 Health."}]
            }
        ]
    },
    {
        ...
        subRules: [
            {
               ...
               subRules: [{
                    ...
                    ruleType:  "RULE",
                    text: [{ text:  "15 + Mettle miles per day along an established road. The speed is halved when traveling without a road."}]
            },
            {
                title:  "Pushing the Pace",
                slug: "PUSHING-PACE",
                ruleType:  "RULE",
                text: [{ text:  "You can push the pace of march. Spend 1 stamina to travel 1 additional mile that day."}]
            },
            {
            ...
            },
            {
               ...
               subRules: [{
                    ...
                    slug: "RUNNING-LEAP",
                    ruleType:  "RULE",
                    text: [{ text:  "If you move up to 10ft before jumping: (4 + 2*Mettle) ft horizontally (Min 2ft)"}]
                },
                {
                    title:  "Standing Leap",
                    slug: "STANDING-LEAP",
        ...
        },
    {
       ...
       subRules: [{
            ...
            },
            {
                title:  "Elvish",
                slug: "ELVISH",
                text: [{ text:  "The common language of elves, spoken with a grace and intertwined lyrical tones."}]
            },
            {
                title:  "Dwarvish",
                slug: "DWARVISH",
                text: [{ text:  "The language of dwarves and others who share their culture. Dwarvish is a robust and resonant tongue, usually spoken loud enough to be heard over the rhythmic clinks of hammers and chisels."}]
            },
            {
                title:  "Thistletongue",
                slug: "THISTLETONGUE",
                text: [{ text:  "The language of faeries and other fae folk. Thistletongue is ethereal, filled with delicate trills and melodic nuances."}]
            },
            {
                title:  "Starrend",
                slug: "STARREND",
                text: [{ text:  "The language of celestials as well as some air elementals and other sky dwellers. Starrend is a celestial tongue, each word carrying the weight of cosmic forces, and is characterized by crystalline tones and etherial echoes."}]
            },
            {
                title:  "Deeproot",
                slug: "DEEPROOT",
                text: [{ text:  "The language of Ents and Stone Colossi. It's a deep and slow language for deep and slow creatures. Deeproot rumbles like the earth, each word a deliberate and ancient utterance resonating with the solidity of stone."}]
            },
            {
                title:  "Seawhisper",
                slug: "SEAWHISPER",
                text: [{ text:  "A fluid and melodic language spoken by merfolk and other denizens of the ocean. Seawhisper uses clicks and sharp bursts of noise and can only properly be spoken under water."}]
            },
            {
                title:  "Voidhowl",
                slug: "VOIDHOWL",
                text: [{ text:  "Spoken by demons and other infernal beings.  Voidhowl is a cacophony of malevolent sounds, mixing guttural growling and ear-splitting shrieks."}]
            }]
        },
        {
            title:  "Damage Types",
            slug:  "DAMAGE-TYPES",
            ruleType:  "RULE",
            text: [{ text:  "Bludgeoning, piercing, slashing, fire, cold, lightning, rot, radiant, & psychic"}]
        },
        {
            title:  "Statuses",
            slug:  "STATUSES",
            ...
            },
            {
                title:  "Blind",
                slug: "BLIND-STATUS",
                text: [{ text:  "You cannot see. All attacks have misfortune and attacks against you gain fortune's favor."}]
            },
            {
                title:  "Deaf",
                slug: "DEAF-STATUS",
            ...
            },
            {
                title:  "Prone",
                slug: "PRONE-STATUS",
                text: [{ text:  "Your speed is reduced by 20ft to a minimum of 5ft. Ranged attacks against you have Misfortune while melee attacks have Fortune's Favor."}]
            },
            {
                title:  "Slowed",
                slug: "SLOWED-STATUS",
