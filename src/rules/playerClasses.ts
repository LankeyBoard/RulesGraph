...
export const playerClasses: CharacterClass[] = [
  ...
  },
  {
    ...
    training: {
      ...
      magic: {
        pick: 1,
        options: ["fire", "cold", "lightning", "rot", "psychic"],
      },
    },
      ...
      },
      {
        ...
        choices: [
          ...
          },
          {
            ...
            text: [{ text: "Increase your Base Attack range by 30 ft." }],
          },
          {
            title: "Bigger Burst",
            slug: "ELEM-BIGGER-BURST",
            text: [{ text: "Increase the size of your burst by 20 ft." }],
          },
        ],
      },
      {
  ...
  },
  {
    ...
    training: {
      ...
      weapons: {
        ...
        ranged: {
          pick: 1,
          options: ["Bows", "Crossbows", "Light Throwing Weapons"],
        },
        special: {
          options: ["whips"],
        },
  ...
  },
  {
    ...
    training: {
      ...
      weapons: {
        melee: {
          pick: 1,
          options: ["Axes", "Piercing Swords & Daggers", "Slashing Swords"],
        },
        ranged: {
          pick: 2,
          options: ["Bows", "Crossbows", "Light Throwing Weapons"],
