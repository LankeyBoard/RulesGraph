...
export const forgotPassword: NonNullable<
  MutationResolvers["forgotPassword"]
...
<html lang=en>
 ...
 <a href="https://fortunes-favor-alpha.netlify.app/passwordReset/${forgotPasswordEntry.id}">https://fortunes-favor-alpha.netlify.app/passwordRest/${forgotPasswordEntry.id}</a>
 </body>
 </html>`,
  );
  return true;
