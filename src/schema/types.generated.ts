...
export type ResolversTypes = {
  ...
  CharacterClass: ResolverTypeWrapper<Omit<CharacterClass, 'deflect' | 'features' | 'variants'> & { deflect: ResolversTypes['Deflect'], features: Array<Maybe<ResolversTypes['CharacterClassFeature']>>, variants?: Maybe<Array<Maybe<ResolversTypes['CharacterClassVariant']>>> }>;
  ...
  CharacterClassVariant: ResolverTypeWrapper<Omit<CharacterClassVariant, 'deflect' | 'features'> & { deflect: ResolversTypes['Deflect'], features: Array<Maybe<ResolversTypes['CharacterClassFeature']>> }>;
  ...
  EncounterMonster: ResolverTypeWrapper<Omit<EncounterMonster, 'features'> & { features: Array<Maybe<ResolversTypes['GenericFeature']>> }>;
...
export type ResolversParentTypes = {
  ...
  CharacterClass: Omit<CharacterClass, 'deflect' | 'features' | 'variants'> & { deflect: ResolversParentTypes['Deflect'], features: Array<Maybe<ResolversParentTypes['CharacterClassFeature']>>, variants?: Maybe<Array<Maybe<ResolversParentTypes['CharacterClassVariant']>>> };
  CharacterClassFeature: Omit<CharacterClassFeature, 'choices'> & { choices?: Maybe<Array<ResolversParentTypes['Choice']>> };
  Boolean: Scalars['Boolean']['output'];
  CharacterClassVariant: Omit<CharacterClassVariant, 'deflect' | 'features'> & { deflect: ResolversParentTypes['Deflect'], features: Array<Maybe<ResolversParentTypes['CharacterClassFeature']>> };
  ...
  EncounterInput: EncounterInput;
  EncounterMonster: Omit<EncounterMonster, 'features'> & { features: Array<Maybe<ResolversParentTypes['GenericFeature']>> };
...
export type CharacterResolvers<ContextType = any, ParentType extends ResolversParentTypes['Character'] = ResolversParentTypes['Character']> = {
  ...
  beast?: Resolver<Maybe<ResolversTypes['BeastForm']>, ParentType, ContextType>;
